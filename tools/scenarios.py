...
CAMPAIGN = [
    ...
    },
    {
        ...
        "roster": {
            "GBR": [("INFANTRY", 2, 4), ("ARMOUR", 2, 3), ("SUPPLY_TRUCK", 1, 3),
                    ("ARTILLERY", 2, 2), ("RECON", 2, 2), ("DESTROYER", 2, 1)],
    ...
    },
    {
        ...
        "roster": {
            "JPN": [("CARRIER", 3, 2), ("TRANSPORT_SHIP", 2, 3), ("MARINE", 2, 4), ("DESTROYER", 2, 2),
    ...
    # ------------------------------------------------------------------
    {
        ...
        "roster": {
            ...
            "FRA": [("MARINE", 3, 3), ("TRANSPORT_SHIP", 2, 2), ("CRUISER", 2, 1)],
    ...
    },
    {
        ...
        "roster": {
            ...
            "USA": [("ARMOUR", 3, 3), ("INFANTRY", 3, 4), ("CARRIER", 3, 1),
    ...
    },
    {
        ...
        "roster": {
            ...
            "FRA": [("ARMOUR", 3, 2), ("ARTILLERY", 3, 1)],
            "GBR": [("ARMOUR", 3, 2), ("DESTROYER", 3, 1)],
            "NLD": [("INFANTRY", 2, 2)],
            "BEL": [("INFANTRY", 2, 2)],
            "DNK": [("INFANTRY", 2, 1), ("ANTI_AIR", 2, 1)],
            "RUS": [("ARMOUR", 3, 6), ("INFANTRY", 3, 4), ("ROCKET", 3, 3),
                    ("ANTI_AIR", 3, 2), ("SUPPLY_TRUCK", 2, 2)],
...
PHILIPPINES = {
    ...
    "roster": {
        "USA": [("CARRIER", 3, 2), ("TRANSPORT_SHIP", 2, 3), ("MARINE", 3, 3), ("BATTLESHIP", 3, 1),
                ("DESTROYER", 2, 3), ("SUBMARINE", 2, 2)],
        "JPN": [("INFANTRY", 2, 6), ("ANTI_AIR", 2, 3), ("ARTILLERY", 2, 2),
                ("DESTROYER", 2, 2), ("CRUISER", 2, 1), ("SUBMARINE", 2, 1)],
        "THA": [("INFANTRY", 1, 2)],
    },
