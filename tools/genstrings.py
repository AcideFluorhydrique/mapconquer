...
UI = {
    ...
    "help_cities_body": (
        ...
        "times what the same unit costs in the open. A city whose defence still stands is shut like an enemy unit: "
        "you cannot walk into it or through it. Attack its defence from next to it or from range; once it reaches "
        "zero and nobody is inside, the first land unit to walk in takes the whole province.\\n\\n"
